...
class CleanupWasSuccessful extends BaseNotification
{
    ...
    {
        $this->message = '**'.__('backup::notifications.cleanup_successful_subject', ['application_name' => $this->applicationName()])."**\n\n";
        $this->message.= __('backup::notifications.cleanup_successful_body', ['application_name' => $this->applicationName(), 'disk_name' => $this->diskName()])."\n";
